 ...
 * Footer Component
 * 
 * Footer minimalista y elegante con información esencial.
...
export function Footer({ config }: FooterProps) {
  ...
  const quickLinks = [
    {
      ...
      links: [
        ...
        { label: 'Venta', href: '/propiedades?status=venta' },
        { label: 'Alquiler', href: '/propiedades?status=alquiler' },
        { label: 'Destacadas', href: '/propiedades?featured=true' },
      ]
    },
    {
      title: 'Empresa',
  ...
  const contactInfo = {
    ...
    phone: '+376 361 617',
    address: ['Andorra la Vella', 'Principado de Andorra']
  };
